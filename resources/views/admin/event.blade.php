          ...
          <table id="example1" class="table  table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th>{{__('general.Start Date')}}</th>
                <th>{{__('general.End Date')}}</th>
            ...
            <tbody>
              ...
              @foreach ($rows as $row)
                <tr>
                  ...
                  <td>
                    <a type="link" href="{{url('/adminLink/events/'.$row->id.'/edit')}}"  class="btn btn-xs btn-success btn-xs" >{{__('general.View')}}</a>
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                ...
                <!-- form-->
                <form class="form-horizontal" method="post" action="{{url('/adminLink/events')}}" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4" >
                        ...
                        <div class="form-group" style="padding: 0 10px !important;">
                          ...
                          <input  class="form-control"  name="event" id="event" value="{{ old('event') }}" placeholder="">
                        </div>
                        <!-- ./input -->
                        ...
                        <div class="form-group" style="padding: 0 10px !important;">
                          ...
                          <input  class="form-control timepicker"  name="start_at" id="start_at" value="{{ old('start_at') }}" placeholder="">
                        </div>
                        <!-- ./input -->
                        ...
                        <div class="form-group" style="padding: 0 10px !important;">
                          ...
                          <input   class="form-control timepicker"  name="end_at" id="end_at" value="{{ old('end_at') }}" placeholder="">
                        </div>
                        <!-- ./input -->
