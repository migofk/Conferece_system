...
@section('pageHeader')
<i class="fa fa-television" aria-hidden="true"></i><span class="text-uppercase"> {{$name}}</span>
@endsection
...
<div class="box">
  ...
  <h4><i class="icon fa fa-check"></i>{{$success}}</h4>
   preview all <a href="{{url('adminLink/slider')}}"> Slideshow</a> .
...
<!--./ success-->
  ...
  <div class="tab-content">
    ...
    <div id="english1" class="tab-pane active in">
      ...
      <!-- form -->
      <form role="form" action="{{url('/adminLink/slider/'.$slider->id)}}" method="post" enctype="multipart/form-data">
         {{ csrf_field() }}
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Title" value="{{$slider->name}}" required>
          </div>
          <!--./ title -->
          ...
          <div class="bootstrap-timepicker">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" id="timeStamp" name="timeStamp" class="form-control timepicker" value="{{$slider->created_at}}">
...
$(function () {
    ...
    $('#featureImage').ezdz('preview', '{{url(''.$slider->featureImage)}}');
    $('.textarea').wysihtml5()
