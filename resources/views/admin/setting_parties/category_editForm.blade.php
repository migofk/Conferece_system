      ...
      <div class="modal-content">
        ...
        <div class="box-body">
         <div class="form-group">
          ...
          <div class="col-sm-10">
          <input type="text" class="form-control" value="" name="category" id="editName" placeholder="">
        </div>
       </div>
       <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">{{__('general.Parent')}}</label>

      <div class="col-sm-10">
      <select  name="parent_id" id="editparent_id" class="form-control" >
        <option></option>
