      ...
      <div class="modal-content">
        ...
        <div class="box-body">
         <div class="form-group">
          ...
          <div class="col-sm-10">
          <input type="text" class="form-control" value="" name="city" id="editName" placeholder="">
        </div>
       </div>
       ...
       <div class="form-group">
         ...
         <div class="col-sm-10">
         <select  name="" id="editcountry_id" class="form-control" required>
           <option></option>
       ...
       <div class="form-group">
         ...
         <div class="col-sm-10">
         <select  name="state_id" id="editstate_id" class="form-control" required>
           <option></option>
