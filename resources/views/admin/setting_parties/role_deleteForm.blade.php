<div class="modal fade" id="modal-roledelete">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- form-->
        <form class="form-horizontal" method="post" action="{{url('/deleteRole')}}">
          @csrf
          <input type="hidden" name="table" value="{{$table}}">
          <input type="hidden" id="itemRoleIDdel" name="role_id" value="">
        <div class="box-body">
         <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">{{__('general.Name')}}</label>

          <div class="col-sm-10">
          <input type="text" disabled class="form-control" value="" name="name" id="itemRolename" placeholder="">
        </div>
       </div>
      </div>
       <!-- /.box-footer -->
