      ...
      <div class="modal-content">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="country" id="name" placeholder="" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" class="form-control" name="calling_code" id="calling_code" placeholder="" required>
            </div>
          </div>
      </div>
       <!-- /.box-footer -->
