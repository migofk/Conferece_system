  ...
  use actionFunctions;
    ...
    public function store(Request $request)
    {
     ...
     $request->end_at = Carbon::parse($request->end_at)->format('Y-m-d H:i:s');
      ...
      return redirect(url('adminLink/events/'.$TheID.'/edit'));
    }
    ...
    public function edit(event $event)
    {
     ...
     [(object)['id' => 0,  'status' => 'Deactive',],
      ...
      return view("admin.event_action",  compact('companies','event','status','name','menuActive','Users','countries','regions','cities','categories'));
    }
