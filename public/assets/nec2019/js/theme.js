...
Version: 		1.0
*/
function changeForm(element1,element2){
$(element1).show();
$(element2).hide();
}
function tabeChangePlus(element){
  $(element).toggleClass("fa-plus-circle");
	$(element).toggleClass("fa-minus-circle");
}


$('#standard-1').click(function(){
changeForm('#standardPackage','#vipPackage');
});
$('#vip-1').click(function(){
changeForm('#vipPackage','#standardPackage');
});


$('body').on('click','.tabHeader',function(){
	var element = $(this).find('i');
	tabeChangePlus(element);
});
