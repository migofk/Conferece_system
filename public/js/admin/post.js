...
if ($("#category").length){
buildTheSelection(categories,'#category');
}
});//get
...
function buildTheTable (array,element){
  ...
  '<tr>'
    ...
    +'<td>'
    +'<a href="/adminWEB/category/'+value.id+'/edit" class="btn btn-primary paddingLeft"><i class="fa fa-edit"> </i> </a> '
    +'<a class="btn btn-primary delete p2 paddingLeft" del-name="'+value.name+'" del-url="/adminWEB/category/'+value.id+'"><i class="fa fa-trash"></i></a> '
    +'<a class="btn btn-'+featureClass+' feature" feat-value="'+value.featured+'" feat-name="'+value.name+'" feat-url="/adminWEB/category/'+value.id+'/feature"><i class="fa fa-star"></i></a> '
    +'</td>'
    +'</tr>'
